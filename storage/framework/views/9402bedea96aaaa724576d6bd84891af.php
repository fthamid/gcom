<div class="d-flex flex-column flex-lg-row align-items-sm-center justify-content-between">
    <!--[if BLOCK]><![endif]--><?php if($recordCount === 'full'): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($paginator->hasPages() && $recordCount != 'min'): ?>
        <nav>
...
<?php /**PATH /home/hamid/gcom/vendor/power-components/livewire-powergrid/src/Providers/../../resources/views/components/frameworks/bootstrap5/pagination.blade.php ENDPATH**/ ?>